...
pthname='resnet34_semilayerdlossplusminus_postponing.pth'
...
#make list about deltaloss
count=0
with open("dataset/ResNet34ImageNetq8642bitdeltaloss.csv",encoding = "utf-8-sig") as f:
    reader = csv.reader(f)
    for row in reader:
        if count == 0: #layernum
            first = row
...
#        dl0value = float(eight[num]) #pruning
        ...
        if lnum == 1 or lnum == 2:
            ...
            layer_index = 1
            block_index = 3
        elif lnum == 15 or lnum == 16:
            layer_index = 2
            block_index = 0            
        elif lnum == 17 or lnum == 18:
            layer_index = 2
            block_index = 1 
        elif lnum == 19 or lnum == 20:
            layer_index = 2
            block_index = 2
        elif lnum == 21 or lnum == 22:            
            layer_index = 2
            block_index = 3             
        elif lnum == 23 or lnum == 24:
            layer_index = 2
            block_index = 4
        elif lnum == 25 or lnum == 26:
            layer_index = 2
            block_index = 5
        elif lnum == 27 or lnum == 28:
            layer_index = 3
            block_index = 0  
        elif lnum == 29 or lnum == 30:
            layer_index = 3
            block_index = 1   
        else:
            layer_index = 3
...
with open("q_answer/mix/resnet34ImageNetq8642bit_accs_semilayer_sortnorkl_lowerdlossplusminus.csv", "a") as f:
    writer = csv.writer(f)
